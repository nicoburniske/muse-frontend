...
export const MemoHeader = memo(
   (props: MemoHeaderProps) => {
      ...
      return <ReviewGroupHeader {...props} onClick={onClick} />
   },
   (prevProps, nextProps) =>
      prevProps.reviewId === nextProps.reviewId && prevProps.parentReviewId === nextProps.parentReviewId
)

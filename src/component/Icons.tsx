...
export const RepeatIcon = ({ text }: { text?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
        ...
        {text ? <text x="50%" y="50%" textAnchor="middle" fill="currentColor" stroke="currentColor" strokeWidth={1} dy=".3em">{text}</text> : null}
    </svg>
)
...
export const HeartSolidIcon = ({ className = '' }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className={`w-6 h-6 ${className}`}>
